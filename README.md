...
This is **Topic Modelling of the Czech Supreme Court Decisions repository** containing all the relevant data and code for topic modelling of the Czech Supreme Court decisions with latent Dirichlet allocation (LDA) and non-negative matrix factorization (NMF) methods.
